...
//let fullName = [];
//const newRunnerArr = runners.forEach(function(runner, index) {
//fullName.push(runner.first_name, index);
//fullName.push(runner.last_name, index);
//});
...
//let allCaps = [];
//const capFirstNames = runners.map(function(runner) {
...
//let largeShirts = [];
//const reorder = runners.filter(function(runner) {
...
//let newPriceDonArr = [];
//const priceDon = runners.map(function(runner) {
//newPriceDonArr.push(runner.donation);
//});
//const totalTicket = newPriceDonArr.reduce(function(acc, price) {
//return acc + price;
////ticketPriceTotal.push(acc + price);
//}, 0);
//ticketPriceTotal.push(totalTicket);
////console.log(newPriceDonArr);
...
//const sortedFirst = runners.map(runner => runner.first_name).sort();
//console.log(sortedFirst);

// Problem 2
// company name and contact only for a blind drawing perhaps
//let prizeEntry = [];
//const mappedCompName = prizeEntry.push(
//runners.map(runner => runner.company_name)
//);
//const mappedCompEmail = prizeEntry.push(runners.map(runner => runner.email));
//console.log(prizeEntry);

// Problem 3
// donations over 100
//const higherDonations = runners.filter(runner => runner.donation > 100);
